...
api.add_resource(SongAPI, '/fcc/change/<string:ref>/<string:typ>')
...
def programming_log():
    if request.method == 'GET':
        ...
        updated_log = update_program_log(program_type, program_name, slot_id, dj_id, new_name)
        return jsonify(updated_log.serialize())
